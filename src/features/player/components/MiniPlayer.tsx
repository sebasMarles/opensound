...
// Mini reproductor persistente que aparece sobre la barra de tabs.
export default function MiniPlayer() {
  const { isPlaying, currentSong, togglePlayPause, next, progress, setPlayerVisible } =
    useMusicPlayer();

  // Si no hay canción activa, ocultamos el mini reproductor para no ocupar espacio.
  ...
  return (
    <View className="bg-neutral-900 border-t border-neutral-800 px-4 py-3">
